...
struct PLANETSIX_API FUseData : public FTableRowBase
{
...
//DECLARE_DELEGATE_OneParam(ItemUse, APlanetSixCharacter*)
...
public:
    ...
    FItemBaseData(int Id, FString DisplayName, float Weight, float Value, int Quantity, UTexture2D* Icon,FUseData Use)
        :id(Id),
        ...
        use(Use)
    {
        //itemUse.BindRaw(this, &FItemBaseData::SayHeal);
    }
    FItemBaseData()
        :id(0),
        displayName(),
...
public:
    ...
    void SayHeal(APlanetSixCharacter* player);
...
//
//    void AddAtributeToPlayer(APlanetSixCharacter* player);
//
//
//};
...
public:
    ...
    UFUNCTION(BlueprintCallable)
        void UseItem(int index, APlanetSixCharacter* player);
